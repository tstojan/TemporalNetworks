...
Prob = ErdosRenyiTemporalErrors_1000_1000(:,2);     %  copy first column of my_xy into x
Err1 = ErdosRenyiTemporalErrors_1000_1000(:,3);     %  and second column into y

load ErdosRenyiTemporalAttack_Closenness_1000_1000.dat;     %  read data into the my_xy matrix
Err2 = ErdosRenyiTemporalAttack_Closenness_1000_1000(:,3);     %  and second column into y

load ErdosRenyiTemporalAttack_FinalHighestDegree_1000_1000.dat;     %  read data into the my_xy matrix
Err3 = ErdosRenyiTemporalAttack_FinalHighestDegree_1000_1000(:,3);     %  and second column into y
...
Err5 = ErdosRenyiTemporalAttack_ContactUpdates_1000_1000(:,3);     %  and second column into y
