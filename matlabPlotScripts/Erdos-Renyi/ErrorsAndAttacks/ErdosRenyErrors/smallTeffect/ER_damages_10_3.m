...
Prob = ErdosRenyiTemporalErrors_1000_0010(:,2);     %  copy first column of my_xy into x
Err1 = ErdosRenyiTemporalErrors_1000_0010(:,3);     %  and second column into y
...
load ErdosRenyiTemporalAttack_FinalHighestDegree_1000_0010.dat;     %  read data into the my_xy matrix
Err3 = ErdosRenyiTemporalAttack_FinalHighestDegree_1000_0010(:,3);     %  and second column into y

load ErdosRenyiTemporalAttack_AverageHighestDegree_1000_0010.dat;     %  read data into the my_xy matrix
Err4 = ErdosRenyiTemporalAttack_AverageHighestDegree_1000_0010(:,3);     %  and second column into y

load ErdosRenyiTemporalAttack_ContactUpdates_1000_0010.dat;     %  read data into the my_xy matrix
Err5 = ErdosRenyiTemporalAttack_ContactUpdates_1000_0010(:,3);     %  and second column into y
