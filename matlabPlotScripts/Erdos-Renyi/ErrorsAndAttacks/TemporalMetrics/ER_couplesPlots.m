...
EffSim = ErdosRenyiTemporalMetricsPlots_100(:,7);     %  and second column into y
EffTheor = ErdosRenyiTemporalMetricsPlots_100(:,8);     %  and second column into y

load ErdosRenyiTemporalMetricsPlots_1000.dat;     %  read data into the my_xy matrix
EffSim1 = ErdosRenyiTemporalMetricsPlots_1000(:,7);     %  and second column into y
EffTheor1 = ErdosRenyiTemporalMetricsPlots_1000(:,7);     %  and second column into y

semilogx(Prob,EffSim,'r.-',Prob,EffTheor,'rS-',Prob,EffSim1,'b.-',Prob,EffTheor1,'bS-');
xlabel('p');           % add axis labels and plot title
ylabel('Connected couples');
axis([0.000001 1.000 0.0 1.000],[0.000001 1.000 0.0 1.000]);
