...
load ErdosRenyiRobustnessTimeDepandances_100.dat;     %  read data into the my_xy matrix
Time = ErdosRenyiRobustnessTimeDepandances_100(:,1);     %  copy first column of my_xy into x
Eff = ErdosRenyiRobustnessTimeDepandances_100(:,2);     %  and second column into y
