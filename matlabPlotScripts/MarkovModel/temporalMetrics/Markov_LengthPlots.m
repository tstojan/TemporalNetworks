...
Eff1 = MarkovTemporalMetricsPlots_100_0_0001(:,4);     %  and second column into y

load MarkovTemporalMetricsPlots_100_0_0010.dat;     %  read data into the my_xy matrix
Eff2 = MarkovTemporalMetricsPlots_100_0_0010(:,4);     %  and second column into y

load MarkovTemporalMetricsPlots_100_0_0100.dat;     %  read data into the my_xy matrix
Eff3 = MarkovTemporalMetricsPlots_100_0_0100(:,4);     %  and second column into y

load MarkovTemporalMetricsPlots_100_0_1000.dat;     %  read data into the my_xy matrix
Eff4 = MarkovTemporalMetricsPlots_100_0_1000(:,4);     %  and second column into y

load MarkovTemporalMetricsPlots_100_1_0000.dat;     %  read data into the my_xy matrix
Eff5 = MarkovTemporalMetricsPlots_100_1_0000(:,4);     %  and second column into y
...
axis([0.000075 1.000 0.0 60.000],[0.000075 1.000 0.0 60.000]);
