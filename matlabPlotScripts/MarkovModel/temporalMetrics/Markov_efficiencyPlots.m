...
Eff1 = MarkovTemporalMetricsPlots_100_0_0001(:,3);     %  and second column into y

load MarkovTemporalMetricsPlots_100_0_0010.dat;     %  read data into the my_xy matrix
Eff2 = MarkovTemporalMetricsPlots_100_0_0010(:,3);     %  and second column into y

load MarkovTemporalMetricsPlots_100_0_0100.dat;     %  read data into the my_xy matrix
Eff3 = MarkovTemporalMetricsPlots_100_0_0100(:,3);     %  and second column into y

load MarkovTemporalMetricsPlots_100_0_1000.dat;     %  read data into the my_xy matrix
Eff4 = MarkovTemporalMetricsPlots_100_0_1000(:,3);     %  and second column into y

load MarkovTemporalMetricsPlots_100_1_0000.dat;     %  read data into the my_xy matrix
Eff5 = MarkovTemporalMetricsPlots_100_1_0000(:,3);     %  and second column into y

semilogx(Prob,Eff1,'r.-',Prob,Eff2,'b.-',Prob,Eff3,'g.-',Prob,Eff4,'c.-',Prob,Eff5,'k.-');
