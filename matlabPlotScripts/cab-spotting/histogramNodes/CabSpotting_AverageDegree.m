load DegreeImportantNodes.txt;     %  read data into the my_xy matrix
data = DegreeImportantNodes(:,3)/(3600);

%x=['2 \lt 2.25','2 \lt 2.25','2 \lt 2.25','2 \lt 2.25','2 \lt 2.25','2 \lt 2.25','2 \lt 2.25','2 \lt 2.25' ];
%y = randn(10000,1);
[a,b]=hist(data(:),0:10:100); 
bar(b,(a*100)/(488),0.82);
%[h,b] = std(data(:));
%figure;
%plot(b,h);
xlabel('Average nodes degree');
ylabel('Frequency %');
grid on;
