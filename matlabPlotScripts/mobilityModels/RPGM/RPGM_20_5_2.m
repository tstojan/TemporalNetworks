...
Prob = RPGM_20x5_10_2_trace_AverageContactUpdates(:,2);     %  copy first column of my_xy into x
Err2 = RPGM_20x5_10_2_trace_AverageContactUpdates(:,3);     %  and second column into y
...
Err1 = RPGM_20x5_10_2_trace_TemporalCloseness(:,3);     %  and second column into y

load RPGM_20x5_10_2_trace_RandomErrors.dat;     %  read data into the my_xy matrix
Err4 = RPGM_20x5_10_2_trace_RandomErrors(:,3);     %  and second column into y
