...
Err1 = RPGM_20x5_10_4_trace_AverageContactUpdates(:,3);     %  and second column into y
...
Err3 = RPGM_20x5_10_2_trace_AverageContactUpdates(:,3);     %  and second column into y

load RPGM_20x5_10_1_trace_AverageContactUpdates.dat;     %  read data into the my_xy matrix
Err4 = RPGM_20x5_10_1_trace_AverageContactUpdates(:,3);     %  and second column into y
