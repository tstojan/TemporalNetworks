...
Prob = RWP_10_3_trace_AverageContactUpdates(:,2);     %  copy first column of my_xy into x
...
Err3 = RWP_10_3_trace_AverageHighestDegree(:,3);     %  and second column into y

load RWP_10_3_trace_TemporalCloseness.dat;     %  read data into the my_xy matrix
Err1 = RWP_10_3_trace_TemporalCloseness(:,3);     %  and second column into y

load RWP_10_3_trace_RandomErrors.dat;     %  read data into the my_xy matrix
Err4 = RWP_10_3_trace_RandomErrors(:,3);     %  and second column into y
