...
Prob = RWP_10_4_trace_TemporalCloseness(:,2);     %  copy first column of my_xy into x
...
Err2 = RWP_10_3_trace_TemporalCloseness(:,3);     %  and second column into y

load RWP_10_2_trace_TemporalCloseness.dat;     %  read data into the my_xy matrix
Err3 = RWP_10_2_trace_TemporalCloseness(:,3);     %  and second column into y

load RWP_10_1_trace_TemporalCloseness.dat;     %  read data into the my_xy matrix
Err4 = RWP_10_1_trace_TemporalCloseness(:,3);     %  and second column into y
