...
Prob = RWP_10_4_trace_AverageHighestDegree(:,2);     %  copy first column of my_xy into x
Err1 = RWP_10_4_trace_AverageHighestDegree(:,3);     %  and second column into y

load RWP_10_3_trace_AverageHighestDegree.dat;     %  read data into the my_xy matrix
Err2 = RWP_10_3_trace_AverageHighestDegree(:,3);     %  and second column into y

load RWP_10_2_trace_AverageHighestDegree.dat;     %  read data into the my_xy matrix
Err3 = RWP_10_2_trace_AverageHighestDegree(:,3);     %  and second column into y

load RWP_10_1_trace_AverageHighestDegree.dat;     %  read data into the my_xy matrix
Err4 = RWP_10_1_trace_AverageHighestDegree(:,3);     %  and second column into y
