...
Prob = RWP_10_2_trace_AverageContactUpdates(:,2);     %  copy first column of my_xy into x
Err2 = RWP_10_2_trace_AverageContactUpdates(:,3);     %  and second column into y
...
Err1 = RWP_10_2_trace_TemporalCloseness(:,3);     %  and second column into y

load RWP_10_2_trace_RandomErrors.dat;     %  read data into the my_xy matrix
Err4 = RWP_10_2_trace_RandomErrors(:,3);     %  and second column into y
