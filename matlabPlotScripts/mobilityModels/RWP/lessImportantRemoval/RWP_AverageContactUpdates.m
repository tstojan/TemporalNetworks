...
Err1 = RWP_10_4_trace_AverageContactUpdates(:,3);     %  and second column into y

load RWP_10_3_trace_AverageContactUpdates.dat;     %  read data into the my_xy matrix
Err2 = RWP_10_3_trace_AverageContactUpdates(:,3);     %  and second column into y

load RWP_10_2_trace_AverageContactUpdates.dat;     %  read data into the my_xy matrix
Err3 = RWP_10_2_trace_AverageContactUpdates(:,3);     %  and second column into y

load RWP_10_1_trace_AverageContactUpdates.dat;     %  read data into the my_xy matrix
Err4 = RWP_10_1_trace_AverageContactUpdates(:,3);     %  and second column into y
